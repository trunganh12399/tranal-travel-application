...
const Restaurant = ({ navigation }) => {
    ...
    var dataMenu = [
        {
            title: 'Buffe hải sản 1',
            images: require('../../../images/image10.png'),
            money: 'Hà nội',
            number: '4',
        },
        {
            title: 'Buffe hải sản 2',
            images: require('../../../images/image10.png'),
            money: 'Hà nội',
            number: '4',
        },
        {
            title: 'Buffe hải sản 3',
            images: require('../../../images/image10.png'),
            money: 'Hà nội',
            number: '4',
        },
        {
            title: 'Buffe hải sản 4',
            images: require('../../../images/image10.png'),
            money: 'Hà nội',
            number: '4',
        },
        {
            title: 'Buffe hải sản 5',
            images: require('../../../images/image10.png'),
            money: 'Hà nội',
            number: '4',
        },
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' ,backgroundColor:'white', borderBottomWidth: 0.5, paddingBottom: 5 }}>
                    <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 20 }}>
                        ...
                        <View>
                            ...
                            <View style={{ flexDirection: "row", marginTop: 10, marginLeft: 20 }} >
                                <Text  >Time :</Text>
                                <Text style={{ color: "#ff8000" }} > 5h30 -10h30 </Text>
                            </View>
                            <View style={{ flexDirection: "row", marginTop: 10, marginLeft: 20 }} >
                                <Text  >Address :</Text>
